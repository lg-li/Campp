#ifndef HALIDE__target___arm___64___HDRCore_h
#define HALIDE__target___arm___64___HDRCore_h
#include <stdint.h>
...
int hdr(struct halide_buffer_t *_images_stack_buffer, uint16_t _black_point, uint16_t _white_point, float _white_balance_r, float _white_balance_g0, float _white_balance_g1, float _white_balance_b, float _tone_mapping_compression, float _tone_mapping_gain, float _sharpen_strength, int32_t _nlm_search_area, int32_t _nlm_patch_size, float _nlm_sigma, struct halide_buffer_t *_depth_map_buffer, struct halide_buffer_t *_8bit_interleaved_output_buffer);

HALIDE_FUNCTION_ATTRS
int hdr_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *hdr_metadata();
